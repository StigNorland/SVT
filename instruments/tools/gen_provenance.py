...
def render(paper: str, issues: list[int], paths: list[str], slug: str) -> str:
    ...
    lines = [
        ...
        r"script links to the exact version --- the commit that last modified it.",
        "",
    ]
...
def generate(paper: str, slug: str, check: bool) -> dict:
    ...
    if not check:
        if skipped:
            ...
            prov.write_text(render(paper, issues, paths, slug), encoding="utf-8")
