...
Paper~VII-b, not a gap in the present argument.  The decisive next step is
numerical --- a direct simulation of a wavefront, or of a defect, refracting
in a graded availability would turn this mechanical account into a tested
one.
