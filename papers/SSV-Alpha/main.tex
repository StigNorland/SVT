...
scale $\mu_0=m_e/\alpha$, the small parameter controlling
...
then the Coulomb coupling, the mass scale $\mu_0$, and the small expansion
...
electron geometry, the mass scale $\mu_0$, weak reconnection scales, and
