...
recognizable entropy. Section 7 distinguishes formal time reversal in equations from physical
reversal in the medium. Section 8 closes with the remaining open technical questions.
...
to a recognizable entropy (Section~\ref{sec:reductions}). Several
