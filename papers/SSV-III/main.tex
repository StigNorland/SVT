...
Loschmidt's paradox, and we claim no such priority.  What is specific to
SSV is the ledger, not the logic: Boltzmann's forgotten variables are here
physical channels of one medium --- phonon phases, Kelvin content, vortex
tangle, correlations --- written in $\Psi$'s defect and excitation
structure rather than in abstract phase space, individually defined,
calibrated, and exchangeable at computable events.  A pre-registered
...
\bibitem{Kibble1976}
T.~W.~B.~Kibble, ``Topology of cosmic domains and strings,''
\textit{J.~Phys.~A} \textbf{9}, 1387--1398 (1976).
