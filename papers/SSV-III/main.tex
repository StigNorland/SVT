...
Section 2 states the ontological claim that time is local change rather than a background
dimension. Section 3 develops the idea that events write wake structure into the medium.
Section 4 reframes entropy as wake-complexity. Section 5 distinguishes formal time reversal in
equations from physical reversal in the medium. Section 6 treats time-travel paradoxes as
category errors. Section 7 closes with the remaining open technical questions.
