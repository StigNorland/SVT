...
$0.3\%$ figure.  The topological node factor $N_Y=3$ is
...
not the source (\ssvissue{183}).  The lineage is
...
\paragraph{What this paper claims.}  The SSV postulate
...
than to free parameters.  The claim-status table states which numbers are
derived, which are structural, and which are candidate-grade pending the
closure work tracked in the issue tracker.
