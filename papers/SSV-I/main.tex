...
$930$--$954\,\mathrm{MeV}$ across the two fine grids, with explicit dependence
...
\texttt{eta} calibration trio) is quarantined in
\texttt{instruments/\_fitted\_quarantine/}, because calibrated inputs flatter
derived results; their own docstrings already
labelled them ``provisional consistency-based calibration rather than a
derived physical constant.''  The honest candidate range at the canonical
cutoff is therefore $m_p\approx 930$--$954\,\text{MeV}$ ($\sim 1.5\%$ of
CODATA) with a documented cutoff systematic, \emph{not} a single-number
$0.3\%$ figure.  The topological trefoil factor $N_Y=3$ is
...
\begin{itemize}
  ...
  \item \textbf{Mass.}
        ...
        \begin{equation}
          ...
          \label{eq:F-integral}
        \end{equation}
        where the integral is over the full 3D breather profile.  The initial
        evaluation used $F\approx4.47$.  The consistency check is
        ...
        cavity geometry.  The numerical extraction of $F$ and its remaining
        cutoff dependence are documented below.
...
the form factor $F$ have been estimated
...
$930$--$954\,\mathrm{MeV}$ whose form factor remains cutoff-dependent.  The
