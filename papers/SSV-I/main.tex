...
\item \textbf{Equilibrium radius (analytic derivation, two structural inputs).}
        ...
        corrected healing length $R_e^* = a_0/\sqrt2$.  What is derived here is
        ...
        \begin{equation}
          \rho_0
            ...
            \approx 9.96\times10^{-5}\;\frac{m_e^4c^3}{\hbar^3}.
          \label{eq:rho0-value}
        \end{equation}
...
$\approx9.96\times10^{-5}\,m_e^4c^3/\hbar^3$, smaller by $\sim2\times10^4$. \\
