...
candidate & Issue~\#30 closure attempts: cutoff invariance
falsified; geometric-$R$ route fails; gate (iii-a) seed-locked;
self-consistent $R_{\rm sc}=0.923\,\xi$ gives $60\%$ spread
(\texttt{static-closure-self-consistent-r-result.md}).
Active: first matched cross-grid test at $n^3=96^3$ vs $72^3$
(same penalty, in progress~2026-06-02,
\texttt{static-closure-n96-prereg.md}). & \#30 \\
...
preservation is not robust under the current soft-penalty relaxer,
as recorded in \texttt{proton-gate-iii-result.md}. & \#30 \\
