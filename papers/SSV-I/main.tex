...
\texttt{src/paper\_i/trefoil\_ny\_derivation.py}.  What remains open:
\begin{itemize}
...
A reference implementation lives under \texttt{src/paper\_i/}: the initial
...
Verified in \texttt{src/paper\_i/trefoil\_ny\_derivation.py};
...
% Regenerate with: python src/tools/gen_provenance.py SSV-I
