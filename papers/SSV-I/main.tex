...
\item \textbf{Equilibrium radius (analytic derivation, two structural inputs).}
        ...
        than typed: \ssvfile{ssv_i_audit_2026} derives each one and
        \texttt{instruments/tools/gen\_values.py} writes it into this document,
        so a printed value cannot drift from the code behind it
        (\ssvissue{198}).
