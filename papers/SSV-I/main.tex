...
the IQV.  The pion ($n=2$, integer sector) is unaffected.  The one remaining
theoretical route is a half-quantum vortex (HQV) electron, which requires a
new foundational decision (issue~\#94) and re-examination of $m_{\pi^\pm}=2\mu_0$.
\end{gapbox}
...
The remaining theoretical route is a half-quantum vortex (HQV) electron
(issue~\#94); this requires a new foundational decision and re-examination
of $m_{\pi^\pm}=2\mu_0$.  The mechanical text below is retained as structural
setup.  Tracking: issues~\#66, \#73, \#76, \#91, \#94.
\end{gapbox}
...
dynamical tests (Path~A/B, issues~\#76, \#91) found the scalar/IQV-spinor BdG
spectrum is not an even ladder and does not produce these as eigenfrequencies,
so they are recorded as numerical coincidences.  The muon's only surviving route
is the half-quantum-vortex topology of issue~\#94; absent that, the ladder
beyond the two topological anchors is numerology.
...
The muon stays a numerical coincidence for the IQV.  The sole remaining
route is a half-quantum vortex (HQV) electron (issue~\#94), which requires a
new foundational decision.  The existing helicity-bridge numerics are retained
as historical diagnostics.
\end{gapbox}
...
$\gamma_B=0$, issue~\#76 null reproduced. The muon returns to
NUMERICAL COINCIDENCE. Remaining route: half-quantum vortex (HQV) electron
with azimuthal spin texture, which requires a new foundational decision and
re-examination of $m_{\pi^\pm}=2\mu_0$ (issue~\#94). Full record:
\texttt{results/spinor/b1-winding-regime-result.md}. & \#66,\#76,\#78,\#87,\#91 \\
