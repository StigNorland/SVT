...
The open problems for Paper~2 are: thin-ring analytic closure of the muon
...
requires the thin-ring analytic calculation deferred to Paper~2.
...
coupling (Appendix~\ref{app:helicity-bridge}); the remaining task for Paper~2
...
be closed analytically in Paper~2.
...
thin-ring analytic closure in Paper~2 will sharpen this to a single number.
...
\begin{itemize}
  ...
  \item The eigenfrequency brackets the observed value
        ...
        bounded, and tractable in Paper~2 via thin-ring analytics.
\end{itemize}
