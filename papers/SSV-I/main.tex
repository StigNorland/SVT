...
and $F\approx4.47$ (analytic estimate; numerical extraction at
inter-strand half-spacing cutoff gives $F\approx4.4$ in the fine-grid
limit, Appendix~\ref{app:minimisation}), giving $N_Y\cdot F\approx13.2$--$13.4$ and
$m_p\approx927$--$941\,\text{MeV}$ ($1.2\%$--$0.3\%$, depending on the
cutoff convention).
...
$p$       & $N_Y\!\cdot\!F\!\cdot\!\mu_0$   & $927$--$941$ & $938.272$ & $0.3$--$1.2\%$\footnotemark[1] \\
\bottomrule
\end{tabular}
\footnotetext[1]{The proton row spans the analytic estimate
$F=4.47$ ($941$\,\text{MeV}, $0.3\%$) and the grid-converged numerical
extraction $F\approx4.4$ at the inter-strand half-spacing cutoff
($927$\,\text{MeV}, $1.2\%$); the spread reflects the cutoff convention used
in the calibration of $\mu_0$ (Appendix~\ref{app:minimisation}).}
\end{table}
