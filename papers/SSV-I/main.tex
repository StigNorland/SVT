...
candidate & Current closure paths are null: Path~B basis enrichment
drifts $\pm13\%$, issue~\#73 finds no direct low
$m_\varphi=\pm1$ branch, and issue~\#76 finds no half-integer
Berry holonomy in the scalar SSV BdG operator.  A positive
derivation requires a changed microscopic ingredient or a future
basis-converged full 3D operator not yet present. &
\#66,\#73,\#76 \\
