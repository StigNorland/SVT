...
candidate & Issue~\#30 closure gates were negative: cutoff
invariance of $N_YF$ is falsified; simple geometric-$R$ extraction
fails; gate (iii-a) is seed-locked/topology-losing under the
current soft-penalty pipeline.  Promotion requires new
topology-preserving static infrastructure or a derived cutoff
observable, not another tuning of the present pipeline. & closed \#30 \\
...
as recorded in \texttt{proton-gate-iii-result.md}. & closed \#30 \\
...
a derived cutoff and a topology-preserving solver; the current
cutoff-invariance and simple geometric-$R$ routes failed. & closed \#30 \\
